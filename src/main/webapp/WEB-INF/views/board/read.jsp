...
<form role="form">
    ...
    <div class="col-lg-12">
        <div class="box box-primary">
            ...
            <textarea class="form-control" rows="5" style="resize: none;" name="content" disabled>${board.content}</textarea>
...
<div class="col-lg-12">
    <div class="box box-warning">
        <div class="box-header with-border">
            <a class=" text-lg" style="list-style-type: none;">댓글작성(<span id="totalReply" style="list-style-type:none;color:red;"></span>)</a>
        </div>
        <div class="box-body">
    ...
    <div class="modal-dialog" style="background-color: white;">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <textarea style="resize: none;" rows="3" class="form-control" id="replyText" name="replyText" placeholder="댓글 내용입력"></textarea>
    ...
    */
    ...
    function repliesListPaging(page){
        ...
        $.getJSON("/replies/"+bno+"/"+page, function(data){
            ...
            let str = "";
            $("#totalReply").html(data.pageMaker.totalCount);
